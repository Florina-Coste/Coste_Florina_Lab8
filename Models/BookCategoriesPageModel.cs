...
namespace Coste_Florina_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Coste_Florina_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Coste_Florina_Lab8Context context,
